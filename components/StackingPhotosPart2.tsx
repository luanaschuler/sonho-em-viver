...
const fotos = [
  { id: 1, src: "/sabao2.webp", rotacao: "-6deg", offset: "-10px" },
  { id: 2, src: "/dancing.webp", rotacao: "4deg", offset: "0px" },
  { id: 3, src: "/stitch.webp", rotacao: "-4deg", offset: "10px" },
  { id: 4, src: "/dancing2.webp", rotacao: "6deg", offset: "20px" }, // Adicionei mais uma para testar
];
  ...
  return (
    <section className="pt-8 pb-24 bg-[#FAFBFF] flex justify-center items-center overflow-hidden">
      <div className="relative w-full max-w-7xl px-4 md:px-6 flex flex-col items-center">
        ...
        <motion.div
          className="relative grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-12 w-full"
          initial="hidden"
          whileInView="visible"
            ...
            >
              ...
              <div className="bg-white p-1.5 md:p-3 pb-4 md:pb-8 rounded-xl md:rounded-2xl shadow-lg shadow-blue-900/10 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300">
                <Image
                  ...
                  width={240}
                  height={320}
                  className="h-40 w-full md:h-72 md:w-56 lg:h-80 lg:w-60 object-cover rounded-xl m:rounded-xl"
                />
              </div>
            </motion.div>
          ))}
